<?php
   ...
   $content = "この度はご登録いただき誠にありがとうございました。\n\n下記、お申込みいただきました内容になります。";
   $content .= "\n------------------------------------------------------------";
   $content .= "\n▼お申し込み情報\n\n■お名前";
   $content .= "\n".$_POST["last_name"]." ".$_POST["first_name"]." (".$_POST["last_name_ja"]." ".$_POST["first_name_ja"].")";
   $content .= "\n\n■お電話番号";
   $content .= "\n".$_POST["phone"];
   $content .= "\n\n■ご住所";
   $content .= "\n".$_POST["address"];
   $content .= "\n------------------------------------------------------------";
   $content .= "\n\n東京大学総括プロジェクト機構「電力ネットワークイノベーション」総括寄附講座 (http://digitalgrid.u-tokyo.ac.jp/)";
   $content .= "\n〒113-0033 東京都文京区本郷7-3-1 工学部3号館306号室";
   $content .= "\nCopyright(C) 2014 The University of Tokyo - Presidential Endowed Chair for Electric Power Network Innovation by Digital Grid";
...
<meta property="og:url" content="http://digitalgrid.u-tokyo.ac.jp">
<meta property="og:email" content="info@digitalgrid.u-tokyo.ac.jp">
...
<script>(function(a,e,f,g,b,c,d){a.GoogleAnalyticsObject=b;a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};a[b].l=1*new Date;c=e.createElement(f);d=e.getElementsByTagName(f)[0];c.async=1;c.src=g;d.parentNode.insertBefore(c,d)})(window,document,"script","//www.google-analytics.com/analytics.js","ga");ga("create","UA-54318293-1","auto");ga('require', 'displayfeatures');ga("send","pageview");</script>
</body>
</html>
